...
\begin{tikzpicture}[line cap=round]
  ...
  \node[font=\small,orange!75!brown] at (4.3,0.1) {diathermal partition};
  ...
  % Arrows for heat transfer
  \draw[-{Stealth[length=10pt]},thick,orange!75!brown] (4.3,2.2) -- ++(-1.0,0.0);
  \draw[-{Stealth[length=10pt]},thick,orange!75!brown] (4.3,1.8) -- ++(1.0,0.0);
