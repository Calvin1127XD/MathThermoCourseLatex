...
\begin{tikzpicture}
    ...
    % Wave parameters (adjusted based on original)
    \def\amplitude{0.4}
    \def\wavelength{3.5}  % Fewer waves (was 2.5)
    ...
    % --- 2. Draw the gray shaded region (ONLY around the boundary) ---
    % This creates a band between upper and lower curves
    \fill[gray!50]
