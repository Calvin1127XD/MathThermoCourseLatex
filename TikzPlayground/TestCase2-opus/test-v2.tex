...
% Diagonal line from label going down-right to the crossing region
% The line goes from below the text (~0.18, 0.78) down to (~0.23, 0.50)
\draw[thick] (axis cs:0.18, 0.78) -- (axis cs:0.23, 0.50);

% Horizontal double-arrow below, showing the gap between binodal and spinodal
% At T~0.35: binodal is at about x=0.165, spinodal is at about x=0.27
\draw[thick, {Stealth[length=3pt]}-{Stealth[length=3pt]}]
    (axis cs:0.165, 0.38) -- (axis cs:0.27, 0.38);
