...
\addplot[name path=f, blue, thick, domain=-0.5:4, samples=200] {0.25*x^2 + 0.5*x + 0.5};
\addplot[name path=h, red, thick, domain=-0.5:4, samples=200] {-0.25*x^2 + 0.5*x + 3.5};
\addplot[name path=g, green!60!black, thick, domain=-0.5:4, samples=200] {0.35*(x-2)^2 + 0.4};
...
% Function labels - positioned at the right end of each curve
\node[blue, right] at (axis cs:4.1, 5.25) {$f(x)$};
\node[red, right] at (axis cs:4.1, 1.5) {$h(x)$};
\node[green!60!black, right] at (axis cs:4.1, 3.5) {$g(x)$};
